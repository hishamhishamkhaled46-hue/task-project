...
// print_r($product);
?>
<form method="POST" action="fun/do_edit_brand.php?id=<?=$id?>" enctype="multipart/form-data">

  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">brand name:</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="name" value = "<?= $brand['name']?>">
  </div>
