                ...
                <div class="col-lg-6">
                  ...
                  <div class="p-5 my-md-4">
                    ...
                    <div class="row align-items-stretch mb-4">
                      ...
                      <div class="col-sm-5 pl-sm-0"><a class="btn btn-dark btn-sm btn-block h-100 d-flex align-items-center justify-content-center px-0" href="ADD_CART.php?proid=<?=$pro['id']?>">Add to cart</a></div>
      ...
      <section class="py-5">
        <div class="container">
          <div class="row mb-5">
            <div class="col-lg-6">
              <!-- PRODUCT SLIDER-->
                   <div class="owl-carousel product-slider" data-slider-id="1"><img src="admin/image/<?=$pro['image']?>" alt=""></div>
            </div>
            <!-- PRODUCT DETAILS-->
            <div class="col-lg-6">
              <ul class="list-inline mb-2">
              ...
              <p class="text-small mb-4"><?=$pro['descr']?></p>
              <div class="row align-items-stretch mb-4">
                ...
                <div class="col-sm-3 pl-sm-0"><a class="btn btn-dark btn-sm btn-block h-100 d-flex align-items-center justify-content-center px-0" href="ADD_CART.php?proid=<?=$pro['id']?>">Add to cart</a></div>
              </div><a class="btn btn-link text-dark p-0 mb-4" href="#"><i class="far fa-heart mr-2"></i>Add to wish list</a><br>
              <ul class="list-unstyled small d-inline-block">
                <li class="px-3 py-2 mb-1 bg-white"><strong class="text-uppercase">Availability:</strong><span class="ml-2 text-muted"><?= $pro['count'] > 0 ? "in stokc" : "out of stock" ?> </span></li>
                <li class="px-3 py-2 mb-1 bg-white text-muted"><strong class="text-uppercase text-dark">View:</strong><a class="reset-anchor ml-2" href="#"><?= $newview?></a></li>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
              <div class="product text-center">
                <div class="position-relative mb-3">
                  <div class="badge text-white badge-info">New</div><a class="d-block" href="detail.php"><img class="img-fluid w-100" src="admin/image/<?=$images_array['0']?>" alt="..." style="width:150px;height:250px;"></a>
