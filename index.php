...
?>
                ...
                <div class="col-lg-6">
                  ...
                  <div class="p-5 my-md-4">
                    ...
                    <div class="row align-items-stretch mb-4">
                      ...
                      <div class="col-sm-5 pl-sm-0"><a class="btn btn-dark btn-sm btn-block h-100 d-flex align-items-center justify-content-center px-0" href="ADD_CART.php?proid=<?=$row['id']?>">Add to cart</a></div>
      ...
      <div class="container">
        ...
        <section class="py-5">
          ...
          <div class="row">
             <?php
             $select = "SELECT * FROM `products`ORDER BY price LIMIT 5 ";
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
              <div class="product text-center">
                <div class="position-relative mb-3">
                  <div class="badge text-white badge-info">New</div><a class="d-block" href="detail.php"><img class="img-fluid w-100" src="admin/image/<?=$row['image']?>" alt="..." style="width:150px;height:250px;"></a>
