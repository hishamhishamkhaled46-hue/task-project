            ...
            <div class="col-lg-8 mb-4 mb-lg-0">
              ...
              <div class="table-responsive mb-4">
                <table class="table">
                  ...
                  <tbody>
                    <?php
                    $select_cart = "SELECT * FROM `cart` WHERE admin_id = $admin_id";
                    ...
                    $select = "SELECT * FROM `products` WHERE id = $pro";
                    ...
                    <tr>
                      <th class="pl-0 border-0" scope="row">
                        <div class="media align-items-center"><a class="reset-anchor d-block animsition-link" href="detail.html"><img src="admin/image/<?=$images_array['0']?>" alt="..." width="70"/></a>
